...
// eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types, func-style, @typescript-eslint/explicit-function-return-type, no-restricted-syntax
